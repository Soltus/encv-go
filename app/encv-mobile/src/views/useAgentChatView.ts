...
return Object.assign(_explicitKeys, {
  ...
  formatSessionMeta, autoResize, handleSend, handleStop,
  onPickV2QuickAction, onPickV2Scenario,
  // history
  handleNewSessionFromHistory, handleOpenHistory, handleDeleteSession,
  // close modal
  handleCloseModal, handleClose,
  // dot nav
  userMessageItems, activeUserMessageIdx, onDotClick, scrollToUserMessage,
  dotNavRef, isDotDragging, draggedDotIdx,
  DOT_LONG_PRESS_MS, DOT_DRAG_THRESHOLD_PX, DOT_ITEM_HEIGHT,
  onDotNavPointerDown, onDotNavPointerMove, onDotNavPointerUp,
  // scroll observer
  scrollToBottom, onMainScroll, setupDotObserver, cleanupDotObserver,
