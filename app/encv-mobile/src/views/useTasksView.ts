...
import { onIonViewWillEnter, actionSheetController, alertController, modalController } from '@ionic/vue'
...
return {
  ...
  t,
  // virtual scroll
  contentRef, scrollEl, virtualListRef, ensureScrollEl, initScrollElWithRetry,
  // from useTasksList
  tasks, isInitialLoad, expandedWarningDetail, sortBy,
  showSearch, searchQuery, showFilters,
  filterPlugins, filterTypes, filterStatuses, filterTriggeredBy, statusOptions,
  ...
  viewMode, filterDatePreset, filterDateRange, displayedItems,
  groupedTasksByRunId, pinnedRunIds,
  toggleViewMode,
  workflowService,
