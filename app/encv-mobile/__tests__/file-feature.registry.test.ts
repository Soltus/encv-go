...
import { registerFileFeature, unregisterFileFeature, useFileFeatures } from "@/composables/useFileFeatures";
import type { FileAction, FileBadge, FileFeature } from "@/types/file-feature";
