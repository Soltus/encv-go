...
export default defineConfig({
  ...
  plugins: [fileSizeLimitPlugin(), daisyUiPlugin(), vueComponentCheckPlugin(), vue(), i18nOptimizePlugin(), openlistHealthPlugin(), injectBaseHref(process.env.VITE_BASE || '/openlist-ui/'), dynamicHmrHostPlugin()],
  resolve: {
    alias: {
