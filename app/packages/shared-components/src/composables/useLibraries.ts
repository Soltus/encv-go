...
import { getFrontendDeps } from "@encv/shared-components/runtime/appAssets";
import { getAndroidDeps, isNative } from "@encv/shared-components/runtime/nativeBridge";
...
function buildFromFrontend(): LibraryItem[] {
  ...
  for (const raw of (getFrontendDeps().items ?? []) as Array<any>) {
