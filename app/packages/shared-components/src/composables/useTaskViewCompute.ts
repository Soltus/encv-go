...
import type { ComputeInput, ComputeOutput } from "@encv/shared-components/workers/taskViewCompute.worker";
// 🆕 Vite 原生支持 ?worker import（dev 用 esbuild，build 用 rollup 单独打包）
import TaskViewComputeWorker from "@encv/shared-components/workers/taskViewCompute.worker?worker";
