/**
 * useTaskEventBridge — 唯一 WS 4 件套入口（shared 版）
 *
 * 职责：
...
export { applyTerminalGuard, VALID_TRANSITIONS, validateTransition } from "@encv/shared-components/lib/workflow/state-machine";
