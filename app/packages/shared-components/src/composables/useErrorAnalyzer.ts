 ...
 *
 * 从 encv-mobile/src/composables/useErrorAnalyzer.ts 提升（0 依赖，纯函数）。
 */
...
import type {
  ...
  ErrorSeverity,
  FixSuggestion,
} from "@encv/shared-components/types/errorAnalysis";

export type { ErrorAnalysis, ErrorCategory, ErrorChainStep, ErrorPhase, ErrorSeverity, FixSuggestion };
