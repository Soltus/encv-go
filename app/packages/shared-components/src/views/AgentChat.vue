...
import AgentDebugPanel from "@encv/shared-components/components/agent/AgentDebugPanel.vue";
// 以下组件现在由 DefaultMessagesView.vue 内部导入（引擎渲染路径）
import AttachmentTray from "@encv/shared-components/components/agent/AttachmentTray.vue";
import ContextIcon from "@encv/shared-components/components/agent/ContextIcon.vue";
// 多渲染引擎架构：引擎渲染包装组件
import EngineRenderer from "@encv/shared-components/components/agent/EngineRenderer.vue";
import MockBranchChoiceBar from "@encv/shared-components/components/agent/MockBranchChoiceBar.vue";
import MockPresetBar from "@encv/shared-components/components/agent/MockPresetBar.vue";
import SlashMenu from "@encv/shared-components/components/agent/SlashMenu.vue";
import V2QuickActions from "@encv/shared-components/components/agent/V2QuickActions.vue";
import V2ScenariosMenu from "@encv/shared-components/components/agent/V2ScenariosMenu.vue";
