 ...
 * 2026-07-14 提升（lift）进 shared-components：原 app/encv-mobile/src/views/useFilesView.searchTokens.ts
 *   是唯一实现，shared 测试早已 `import ... from "@encv/shared-components/views/useFilesView.searchTokens"`
 *   此前靠 encv-alias-fallback 回退到 app 解析（假共享）。现补搬进 shared，使该 import 解析到真源。
 */
