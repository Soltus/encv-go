...
import PerformanceTab from "@encv/shared-components/components/PerformanceTab.vue";
import PipelineTab from "@encv/shared-components/components/PipelineTab.vue";
import TasksTab from "@encv/shared-components/components/TasksTab.vue";
...
const { params: navParams, replace } = getAppNavigation();
...
// ============ 路由参数 ============
const runId = computed(() => decodeURIComponent(String(navParams.value.runId ?? "")));
